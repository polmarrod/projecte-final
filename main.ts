...
function initializeMenu () {
    backgroundmenu = sprites.create(assets.image`background-menu`, SpriteKind.images)
    mario = sprites.create(assets.image`mario_stan_def`, SpriteKind.Player)
    title_onep = sprites.create(assets.image`title-1-player`, SpriteKind.game_option)
    title_twop = sprites.create(assets.image`title-2-player`, SpriteKind.game_option)
    selector_ig = sprites.create(assets.image`selector`, SpriteKind.game_option)
    selector = 0
